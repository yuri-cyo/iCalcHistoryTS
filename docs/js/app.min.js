...
this.varDigitStr="",this.$buttonAC=document.querySelector("[data-clear]"),this.$buttonsMath=document.querySelectorAll("[data-math]"),this.negativeCount=1,this.equalCount=1,this.numA="",this.symbol="",this.numB="",this.resultAB="",this.returnAorB="",this.statusnoNumBEqualNumA=!1,this.digitCopy="",this.arrDigigt=["0"],this.mOn=!1,this.m=0,this.$screenM=document.querySelector(".calc__m-screen")}btnsTouchNumbers(){document.body.addEventListener("touchstart",(t=>{t.target.className.includes("button")&&t.target.closest(".button")&&"vibrate"in navigator&&navigator.vibrate(75);let i="",s=t.target.className;s.includes("button__m")&&(i="#737371"),s.includes("button__control")&&(i="#D9D9D9"),s.includes("button__number")&&(i="#737373"),s.includes("button__math")&&(i="#F3C895"),t.target.style.backgroundColor=i,t.target.style.transition="background-color 0s, opacity 0.5s, transform 0.2s"}),!1),document.body.addEventListener("touchend",(function(t){t.target.className;t.target.style.transition="background-color 0.5s, opacity 0.5s, transform 0.2s",setTimeout((function(){t.target.style.backgroundColor=""}),20)}),!1)}buttonACContent(){""!==this.numA||""!==this.numB?this.$buttonAC.innerHTML="C":""!==this.numA&&""!==this.numB||(this.$buttonAC.innerHTML="AC")}buttonAC(){"ac"===this.targetDataSet.clear&&(this.clearVars(),console.warn("AC clear!"))}clearVars(){this.$digit.innerHTML="0",this.varDigitStr="0",this.numA="",this.numB="",this.symbol="",this.resultAB="",this.returnAorB="",this.negativeCount=1,//!
...
this.numB=this.fnToFixed(this.numB/100),this.varDigitStr=this.numB,console.log("if percent",4))))}btnMplus(t){"mc"===t.dataset.m&&(this.m=0,this.$screenM.innerHTML="",this.mOn=!1),"m+"===t.dataset.m&&(this.mOn=!0,""!==this.numA&&""!==this.numB&&""!==this.symbol?(this.buttonsEqual(),this.m=Number(this.m)+Number(this.varDigitStr),this.noNumBEqualNumA()):this.m=Number(this.m)+Number(this.varDigitStr),this.$screenM.innerHTML=this.m,this.numA="",this.numB="",this.symbol=""),"m-"===t.dataset.m&&(this.mOn=!0,""!==this.numA&&""!==this.numB&&""!==this.symbol?(this.buttonsEqual(),this.m=Number(this.m)-Number(this.varDigitStr),this.noNumBEqualNumA()):this.m=Number(this.m)-Number(this.varDigitStr),this.$screenM.innerHTML=this.m,this.numA="",this.numB="",this.symbol=""),"mr"===t.dataset.m&&(""===this.numB&&""===this.symbol?(this.numA=this.m,this.varDigitStr=""+this.m):""!==this.numA&&""!==this.symbol&&(this.numB=this.m,this.varDigitStr=""+this.m))}}("buttonsCalc",{numberLimit:9});t.btnsTouchNumbers(),t.$el.addEventListener("click",(i=>{i.target.closest(".button")&&(t.targetDataSet=i.target.dataset,t.target=i.target,console.warn("press targetttttttttttttttttttttttttttttttt!!! "+t.targetDataSet),t.targetDataSet,t.symbolEntry(),t.varDigitStr.length<=t.numberLimit&&(t.varDigitStr.includes(".")||t.varDigitStr.length<t.numberLimit)&&t.numbersEntryAorB(),t.buttonNegative(),t.equalSymbol(),//! 1+2+3 FIX PROBLEM! OLD
