...
this.numB=this.fnToFixed(this.numB/100),this.varDigitStr=this.numB,console.log("if percent",4))))}}("buttonsCalc",{numberLimit:9});t.$el.addEventListener("click",(i=>{i.target.closest(".button")&&(t.targetDataSet=i.target.dataset,t.target=i.target,console.warn("press targetttttttttttttttttttttttttttttttt!!! "+t.targetDataSet),t.targetDataSet,t.symbolEntry(),t.varDigitStr.length<t.numberLimit+1&&(t.varDigitStr.includes(".")||t.varDigitStr.length<t.numberLimit)&&t.numbersEntryAorB(),t.buttonNegative(),t.equalSymbol(),//! 1+2+3 FIX PROBLEM! OLD
